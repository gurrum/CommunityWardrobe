...
public class NGORegistrationController {
  ...
  @RequestMapping(value = "/ngodetail/{ngoUserId}", method = RequestMethod.GET)
  @ResponseBody
  public ResponseEntity<NGORegistrationDTO> getNGO(@RequestParam String ngoUserId){
    NGORegistrationDTO response = ngoRegistrationService.getNGORegistration(ngoUserId);
